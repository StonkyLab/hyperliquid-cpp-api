...
#ifndef INCLUDE_STONKY_HYPERLIQUID_TLS_VERIFY_H
#define INCLUDE_STONKY_HYPERLIQUID_TLS_VERIFY_H
...
/**
 * Turn on TLS peer-certificate verification for a client context (asio
 * defaults to verify_none). Same helper as the other connectors; see the
 * Lighter twin for the full rationale.
 */
...
#endif // INCLUDE_STONKY_HYPERLIQUID_TLS_VERIFY_H
